...
type z_ZodObject<T extends ZodRawShape = ZodRawShape, UnknownKeys extends UnknownKeysParam = UnknownKeysParam, Catchall extends ZodTypeAny = ZodTypeAny, Output = objectOutputType<T, Catchall, UnknownKeys>, Input = objectInputType<T, Catchall, UnknownKeys>> = ZodObject<T, UnknownKeys, Catchall, Output, Input>;
...
declare function isArraySchema(schema: JSONSchema): schema is ArraySchema;
...
type transformErrors_JsonSchemaToZuiError = JsonSchemaToZuiError;
declare const transformErrors_JsonSchemaToZuiError: typeof JsonSchemaToZuiError;
type transformErrors_ObjectToZuiError = ObjectToZuiError;
declare const transformErrors_ObjectToZuiError: typeof ObjectToZuiError;
type transformErrors_UnrepresentableGenericError = UnrepresentableGenericError;
declare const transformErrors_UnrepresentableGenericError: typeof UnrepresentableGenericError;
type transformErrors_UnsupportedZuiToJsonSchemaError = UnsupportedZuiToJsonSchemaError;
declare const transformErrors_UnsupportedZuiToJsonSchemaError: typeof UnsupportedZuiToJsonSchemaError;
type transformErrors_UnsupportedZuiToTypescriptSchemaError = UnsupportedZuiToTypescriptSchemaError;
declare const transformErrors_UnsupportedZuiToTypescriptSchemaError: typeof UnsupportedZuiToTypescriptSchemaError;
type transformErrors_UnsupportedZuiToTypescriptTypeError = UnsupportedZuiToTypescriptTypeError;
declare const transformErrors_UnsupportedZuiToTypescriptTypeError: typeof UnsupportedZuiToTypescriptTypeError;
type transformErrors_UntitledDeclarationError = UntitledDeclarationError;
declare const transformErrors_UntitledDeclarationError: typeof UntitledDeclarationError;
type transformErrors_ZuiToJsonSchemaError = ZuiToJsonSchemaError;
declare const transformErrors_ZuiToJsonSchemaError: typeof ZuiToJsonSchemaError;
type transformErrors_ZuiToTypescriptSchemaError = ZuiToTypescriptSchemaError;
declare const transformErrors_ZuiToTypescriptSchemaError: typeof ZuiToTypescriptSchemaError;
type transformErrors_ZuiToTypescriptTypeError = ZuiToTypescriptTypeError;
declare const transformErrors_ZuiToTypescriptTypeError: typeof ZuiToTypescriptTypeError;
type transformErrors_ZuiTransformError = ZuiTransformError;
declare const transformErrors_ZuiTransformError: typeof ZuiTransformError;
declare namespace transformErrors {
  export { transformErrors_JsonSchemaToZuiError as JsonSchemaToZuiError, transformErrors_ObjectToZuiError as ObjectToZuiError, transformErrors_UnrepresentableGenericError as UnrepresentableGenericError, transformErrors_UnsupportedZuiToJsonSchemaError as UnsupportedZuiToJsonSchemaError, transformErrors_UnsupportedZuiToTypescriptSchemaError as UnsupportedZuiToTypescriptSchemaError, transformErrors_UnsupportedZuiToTypescriptTypeError as UnsupportedZuiToTypescriptTypeError, transformErrors_UntitledDeclarationError as UntitledDeclarationError, transformErrors_ZuiToJsonSchemaError as ZuiToJsonSchemaError, transformErrors_ZuiToTypescriptSchemaError as ZuiToTypescriptSchemaError, transformErrors_ZuiToTypescriptTypeError as ZuiToTypescriptTypeError, transformErrors_ZuiTransformError as ZuiTransformError };
}

declare const transforms: {
    errors: typeof transformErrors;
